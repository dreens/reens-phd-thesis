...
\begin{equation}
\bar{c}\bigg|_{T_L}^{T_H} = \dot{Q}L/A,
\end{equation}
where $\bar{c}$ is the antiderivative of $c$.
We may proceed using the data from~\cite{Sondericker1994} for slightly glass-filled Ultem 2100, which shows $0.04$~W/m$^\circ$K at $10\!~^\circ$K, $0.3$~W/m$^\circ$K at $3000\!~^\circ$K, and an approximately straight line on a log-log plot in between.
This implies
